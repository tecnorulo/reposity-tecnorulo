...
SOURCES = [{"url": "http://bit.ly/deadpooladdon", "fanart": "http://i.imgur.com/m6B40SU.png"}]

# hthttp://i.imgur.com/m6B40SU.png
# http://i.imgur.com/m6B40SU.png
...
def addon_log(string):
    if debug == 'true':
        xbmc.log("[addon.video.deadpool-%s]: %s" %(addon_version, string))
...
def urlsolver(url):
    ...
    try:
        ...
        xbmc.executebuiltin("XBMC.Notification(deadpool,Please enable Update Commonresolvers to Play in Settings. - ,10000)")

    resolved=genesisresolvers.get(url).result
    if url == resolved or resolved is None:
        #import
        xbmc.executebuiltin("XBMC.Notification(deadpool,Using Urlresolver module.. - ,5000)")
        import urlresolver
...
def search(site_name,search_term=None):
    ...
    if 'youtube' in site_name:
        ...
        if res == 'True':
            ...
            xbmc.executebuiltin("XBMC.Notification(deadpool,No IMDB match found ,7000,"+icon+")")
